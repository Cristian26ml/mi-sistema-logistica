...
class Command(BaseCommand):
    help = "Inicializa ProductContainer con el stock_actual de cada producto en ALMACEN_VIRTUAL"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Inicializados {count} productos en ProductContainer con stock_actual."
        ))
